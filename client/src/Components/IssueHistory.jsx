...
//     try {
//       const response = await fetch("http://localhost:8080/api/user/return-book", {
//         method: "POST",
//         headers: {
...
//       const data = await response.json();
//       if (response.ok) {
//         // Update the UI to reflect the book returned
//         alert(data.message); // You can show a success message here
//         // Refresh the users list after return
...
//                         onClick={() =>
//                           handleReturnBook(user._id, book.bookId._id)
//                         }
//                       >
//                         Returned
//                       </button>
